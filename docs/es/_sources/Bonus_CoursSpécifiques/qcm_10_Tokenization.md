...
<div class="qcm-container">
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">¿Cuál es la principal función de un <em>tokenizer</em> en el contexto de los modelos de lenguaje (LLM)?</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, true, 'A', 1)" data-question="1">
                    <div class="answer-option">A</div>
                    <div class="answer-text">Convertir un texto en una secuencia de enteros (<em>tokens</em>)</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 1)" data-question="1">
                    <div class="answer-option">B</div>
                    <div class="answer-text">Traducir un texto de un idioma a otro</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 1)" data-question="1">
                    <div class="answer-option">C</div>
                    <div class="answer-text">Generar respuestas a partir de un contexto dado</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 1)" data-question="1">
                    <div class="answer-option">D</div>
                    <div class="answer-text">Evaluar el rendimiento de un modelo de lenguaje</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">¿Por qué los LLM suelen tener dificultades para realizar operaciones simples en cadenas de caracteres, como invertir una palabra?</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 2)" data-question="2">
                    <div class="answer-option">A</div>
                    <div class="answer-text">Porque los LLM no comprenden la sintaxis de las palabras</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, true, 'B', 2)" data-question="2">
                    <div class="answer-option">B</div>
                    <div class="answer-text">Porque las palabras se tokenizan en fragmentos de caracteres y no carácter por carácter</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 2)" data-question="2">
                    <div class="answer-option">C</div>
                    <div class="answer-text">Porque los modelos de lenguaje no procesan cadenas de caracteres</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 2)" data-question="2">
                    <div class="answer-option">D</div>
                    <div class="answer-text">Porque el vocabulario de los LLM es demasiado pequeño para contener todas las palabras</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">¿Cuál es la principal ventaja del algoritmo <em>byte-pair encoding</em> (BPE) en la construcción de un <em>tokenizer</em>?</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 3)" data-question="3">
                    <div class="answer-option">A</div>
                    <div class="answer-text">Reduce el tamaño del vocabulario a menos de 100 <em>tokens</em></div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, true, 'B', 3)" data-question="3">
                    <div class="answer-option">B</div>
                    <div class="answer-text">Permite aumentar el tamaño del vocabulario al tiempo que reduce la longitud de las secuencias tokenizadas</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 3)" data-question="3">
                    <div class="answer-option">C</div>
                    <div class="answer-text">Traduce automáticamente los textos al inglés</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 3)" data-question="3">
                    <div class="answer-option">D</div>
                    <div class="answer-text">Reemplaza cada palabra por un solo carácter Unicode</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">¿Por qué el <em>tokenizer</em> de GPT-2 hace que el modelo sea menos eficiente para procesar código Python?</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 4)" data-question="4">
                    <div class="answer-option">A</div>
                    <div class="answer-text">Porque Python usa caracteres especiales no reconocidos por GPT-2</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, true, 'B', 4)" data-question="4">
                    <div class="answer-option">B</div>
                    <div class="answer-text">Porque cada espacio de indentación se cuenta como un <em>token</em> separado, aumentando rápidamente el tamaño del contexto</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 4)" data-question="4">
                    <div class="answer-option">C</div>
                    <div class="answer-text">Porque GPT-2 no comprende la sintaxis de los lenguajes de programación</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 4)" data-question="4">
                    <div class="answer-option">D</div>
                    <div class="answer-text">Porque GPT-2 no puede tokenizar correctamente los números</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">¿Cuál es el principal impacto de un <em>tokenizer</em> entrenado mayoritariamente con datos en inglés en el rendimiento de un LLM en otros idiomas?</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, true, 'A', 5)" data-question="5">
                    <div class="answer-option">A</div>
                    <div class="answer-text">El modelo usa más <em>tokens</em> para expresar una misma frase en otros idiomas, lo que limita el tamaño del contexto efectivo</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 5)" data-question="5">
                    <div class="answer-option">B</div>
                    <div class="answer-text">El modelo traduce automáticamente los textos extranjeros al inglés antes de procesarlos</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 5)" data-question="5">
                    <div class="answer-option">C</div>
                    <div class="answer-text">El <em>tokenizer</em> elimina todos los caracteres no ingleses</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 5)" data-question="5">
                    <div class="answer-option">D</div>
                    <div class="answer-text">El modelo funciona mejor en japonés que en inglés</div>
                </button>
