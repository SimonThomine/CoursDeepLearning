...
<div class="qcm-container">
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">¿Cuál es la principal razón para usar el aumento de datos en el aprendizaje profundo?</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 1)" data-question="1">
                    <div class="answer-option">A</div>
                    <div class="answer-text">Reducir el tamaño del modelo</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, true, 'B', 1)" data-question="1">
                    <div class="answer-option">B</div>
                    <div class="answer-text">Aumentar artificialmente la cantidad de datos de entrenamiento</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 1)" data-question="1">
                    <div class="answer-option">C</div>
                    <div class="answer-text">Simplificar el proceso de etiquetado de datos</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 1)" data-question="1">
                    <div class="answer-option">D</div>
                    <div class="answer-text">Eliminar la necesidad de validación cruzada</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">Entre las siguientes transformaciones para imágenes, ¿cuál requiere especial atención según el objetivo de entrenamiento?</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 2)" data-question="2">
                    <div class="answer-option">A</div>
                    <div class="answer-text">Inversión horizontal</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, true, 'B', 2)" data-question="2">
                    <div class="answer-option">B</div>
                    <div class="answer-text">Rotación de 90 grados</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 2)" data-question="2">
                    <div class="answer-option">C</div>
                    <div class="answer-text">Cambio de luminosidad</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 2)" data-question="2">
                    <div class="answer-option">D</div>
                    <div class="answer-text">Adición de ruido gaussiano</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">¿Qué técnica de aumento de datos para imágenes puede ser problemática si el objeto principal no está bien presente en el área seleccionada?</div>
            </div>
            <div class="answers">
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">En PLN, ¿qué método de aumento de datos puede hacer que un modelo sea más robusto, pero puede ser peligroso si se usa mal?</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, false, 'C', 4)" data-question="4">
                    <div class="answer-option">A</div>
                    <div class="answer-text">Reemplazo de palabras por sinónimos</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'C', 4)" data-question="4">
                    <div class="answer-option">B</div>
                    <div class="answer-text">Paráfrasis</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, true, 'C', 4)" data-question="4">
                    <div class="answer-option">C</div>
                    <div class="answer-text">Cambio aleatorio de la posición de ciertas palabras en una frase</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'C', 4)" data-question="4">
                    <div class="answer-option">D</div>
                    <div class="answer-text">Adición de ruido en el texto</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">¿Qué técnica de aumento de datos de audio consiste en modificar la altura del sonido?</div>
            </div>
            <div class="answers">
                ...
                <button class="answer-button" onclick="checkAnswer(this, false, 'D', 5)" data-question="5">
                    <div class="answer-option">B</div>
                    <div class="answer-text">Desplazamiento de la grabación</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'D', 5)" data-question="5">
                    <div class="answer-option">C</div>
                    <div class="answer-text">Cambio de la velocidad de grabación</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, true, 'D', 5)" data-question="5">
                    <div class="answer-option">D</div>
                    <div class="answer-text">Modificación de la tonalidad para hacer el sonido más agudo o más grave</div>
                </button>
