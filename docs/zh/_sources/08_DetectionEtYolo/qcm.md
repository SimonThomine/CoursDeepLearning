...
<div class="qcm-container">
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">两阶段目标检测器（two-stage detector）与单阶段目标检测器（one-stage detector）的主要区别是什么？</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, false, 'C', 1)" data-question="1">
                    <div class="answer-option">A</div>
                    <div class="answer-text">两阶段检测器直接产生类别和边界框，而单阶段检测器首先生成区域候选。</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'C', 1)" data-question="1">
                    <div class="answer-option">B</div>
                    <div class="answer-text">两阶段检测器使用 Transformer，单阶段检测器仅使用 CNN。</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, true, 'C', 1)" data-question="1">
                    <div class="answer-option">C</div>
                    <div class="answer-text">两阶段检测器首先生成区域候选并优化检测，单阶段检测器在单一步骤中直接预测边界框和类别。</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'C', 1)" data-question="1">
                    <div class="answer-option">D</div>
                    <div class="answer-text">单阶段检测器总是比两阶段检测器更精确。</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">在原始 YOLO 架构中，如何确定负责检测某个物体的网格单元？</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, true, 'A', 2)" data-question="2">
                    <div class="answer-option">A</div>
                    <div class="answer-text">包含物体中心的网格单元负责检测该物体。</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 2)" data-question="2">
                    <div class="answer-option">B</div>
                    <div class="answer-text">与物体重叠面积最大的网格单元负责。</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 2)" data-question="2">
                    <div class="answer-option">C</div>
                    <div class="answer-text">所有网格单元预测所有边界框和类别，没有特定分配。</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 2)" data-question="2">
                    <div class="answer-option">D</div>
                    <div class="answer-text">物体左上角所在的网格单元负责。</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">非极大值抑制（Non-Maximum Suppression, NMS）在目标检测中的主要作用是什么？</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 3)" data-question="3">
                    <div class="answer-option">A</div>
                    <div class="answer-text">在检测前提高图像分辨率。</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, true, 'B', 3)" data-question="3">
                    <div class="answer-option">B</div>
                    <div class="answer-text">将多个重叠的边界框预测合并为每个物体的单一检测结果。</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 3)" data-question="3">
                    <div class="answer-option">C</div>
                    <div class="answer-text">生成目标检测的区域候选。</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 3)" data-question="3">
                    <div class="answer-option">D</div>
                    <div class="answer-text">减小模型使用的锚框尺寸。</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">YOLOv2 相较于原始 YOLO 版本引入的主要创新是什么？</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 4)" data-question="4">
                    <div class="answer-option">A</div>
                    <div class="answer-text">使用 Darknet-53 主干网络。</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, true, 'B', 4)" data-question="4">
                    <div class="answer-option">B</div>
                    <div class="answer-text">引入锚框（anchor boxes）以提高定位精度。</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 4)" data-question="4">
                    <div class="answer-option">C</div>
                    <div class="answer-text">添加多尺度检测。</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 4)" data-question="4">
                    <div class="answer-option">D</div>
                    <div class="answer-text">使用 Transformer 编码器。</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">原始 YOLO 算法基于网格单元预测的一个主要限制是什么？</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, true, 'A', 5)" data-question="5">
                    <div class="answer-option">A</div>
                    <div class="answer-text">每个单元只能预测一个类别但可预测多个边界框。</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 5)" data-question="5">
                    <div class="answer-option">B</div>
                    <div class="answer-text">每个单元可检测多个不同类别的物体。</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 5)" data-question="5">
                    <div class="answer-option">C</div>
                    <div class="answer-text">模型仅预测物体的类别而不预测位置。</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 5)" data-question="5">
                    <div class="answer-option">D</div>
                    <div class="answer-text">每个单元只能预测一个边界框和一个类别。</div>
                </button>
