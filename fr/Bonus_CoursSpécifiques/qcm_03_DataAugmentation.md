...
<div class="qcm-container">
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">Quelle est la principale raison d'utiliser la data augmentation en deep learning ?  </div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 1)" data-question="1">
                    <div class="answer-option">A</div>
                    <div class="answer-text">Réduire la taille du modèle</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, true, 'B', 1)" data-question="1">
                    <div class="answer-option">B</div>
                    <div class="answer-text">Augmenter artificiellement la quantité de données d'entraînement</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 1)" data-question="1">
                    <div class="answer-option">C</div>
                    <div class="answer-text">Simplifier le processus de labellisation des données</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 1)" data-question="1">
                    <div class="answer-option">D</div>
                    <div class="answer-text">Éliminer le besoin de validation croisée</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">Parmi les transformations suivantes pour les images, laquelle nécessite une vigilance particulière selon l'objectif d'entraînement ?  </div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 2)" data-question="2">
                    <div class="answer-option">A</div>
                    <div class="answer-text">Inversion horizontale</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, true, 'B', 2)" data-question="2">
                    <div class="answer-option">B</div>
                    <div class="answer-text">Rotation de 90 degrés</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 2)" data-question="2">
                    <div class="answer-option">C</div>
                    <div class="answer-text">Changement de luminosité</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 2)" data-question="2">
                    <div class="answer-option">D</div>
                    <div class="answer-text">Ajout de bruit gaussien</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">Quelle technique de data augmentation pour les images peut être problématique si l'objet principal n'est pas bien présent dans la zone sélectionnée ?  </div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, true, 'A', 3)" data-question="3">
                    <div class="answer-option">A</div>
                    <div class="answer-text">RandomCrop</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 3)" data-question="3">
                    <div class="answer-option">B</div>
                    <div class="answer-text">RandomHorizontalFlip</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 3)" data-question="3">
                    <div class="answer-option">C</div>
                    <div class="answer-text">ColorJitter</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 3)" data-question="3">
                    <div class="answer-option">D</div>
                    <div class="answer-text">RandomErasing</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">En NLP, quelle méthode de data augmentation est susceptible de rendre un modèle plus robuste mais peut être dangereuse si elle est mal utilisée ?  </div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, false, 'C', 4)" data-question="4">
                    <div class="answer-option">A</div>
                    <div class="answer-text">Remplacement de mots par des synonymes</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'C', 4)" data-question="4">
                    <div class="answer-option">B</div>
                    <div class="answer-text">Paraphrasage</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, true, 'C', 4)" data-question="4">
                    <div class="answer-option">C</div>
                    <div class="answer-text">Changement aléatoire de la position de certains mots dans une phrase</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'C', 4)" data-question="4">
                    <div class="answer-option">D</div>
                    <div class="answer-text">Ajout de bruit dans le texte</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">Quelle technique de data augmentation audio consiste à modifier la hauteur du son ?  </div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, false, 'D', 5)" data-question="5">
                    <div class="answer-option">A</div>
                    <div class="answer-text">Ajout de bruit gaussien</div>
                </button>
                ...
                <button class="answer-button" onclick="checkAnswer(this, false, 'D', 5)" data-question="5">
                    <div class="answer-option">B</div>
                    <div class="answer-text">Décalage de l'enregistrement</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'D', 5)" data-question="5">
                    <div class="answer-option">C</div>
                    <div class="answer-text">Changement de la vitesse d'enregistrement</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, true, 'D', 5)" data-question="5">
                    <div class="answer-option">D</div>
                    <div class="answer-text">Modification de la tonalité pour rendre le son plus aigu ou plus grave</div>
                </button>
