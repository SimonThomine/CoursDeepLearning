...
<div class="qcm-container">
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">¿Cuál es la principal diferencia entre un detector de objetos en dos etapas (two-stage detector) y un detector en una etapa (one-stage detector)?</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, false, 'C', 1)" data-question="1">
                    <div class="answer-option">A</div>
                    <div class="answer-text">El two-stage detector produce directamente las clases y las cajas, mientras que el one-stage detector genera primero propuestas de regiones.</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'C', 1)" data-question="1">
                    <div class="answer-option">B</div>
                    <div class="answer-text">El two-stage detector utiliza un transformer, el one-stage detector utiliza únicamente una CNN.</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, true, 'C', 1)" data-question="1">
                    <div class="answer-option">C</div>
                    <div class="answer-text">El two-stage detector genera primero propuestas de regiones y luego afina la detección, el one-stage detector predice directamente las cajas y clases en un solo paso.</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'C', 1)" data-question="1">
                    <div class="answer-option">D</div>
                    <div class="answer-text">El one-stage detector siempre es más preciso que el two-stage detector.</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">En la arquitectura YOLO original, ¿cómo se determina la celda responsable de la detección de un objeto?</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, true, 'A', 2)" data-question="2">
                    <div class="answer-option">A</div>
                    <div class="answer-text">La celda que contiene el centro del objeto en la cuadrícula es responsable de la detección.</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 2)" data-question="2">
                    <div class="answer-option">B</div>
                    <div class="answer-text">La celda que tiene la mayor área del objeto es responsable.</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 2)" data-question="2">
                    <div class="answer-option">C</div>
                    <div class="answer-text">Todas las celdas predicen todas las cajas y clases, sin asignación específica.</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 2)" data-question="2">
                    <div class="answer-option">D</div>
                    <div class="answer-text">La celda en la esquina superior izquierda del objeto es responsable.</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">¿Cuál es el papel principal de la supresión no máxima (Non-Maximum Suppression, NMS) en la detección de objetos?</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 3)" data-question="3">
                    <div class="answer-option">A</div>
                    <div class="answer-text">Mejorar la resolución de la imagen antes de la detección.</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, true, 'B', 3)" data-question="3">
                    <div class="answer-option">B</div>
                    <div class="answer-text">Fusionar varias predicciones de cajas que se superponen en una sola detección por objeto.</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 3)" data-question="3">
                    <div class="answer-option">C</div>
                    <div class="answer-text">Generar propuestas de regiones para la detección.</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 3)" data-question="3">
                    <div class="answer-option">D</div>
                    <div class="answer-text">Reducir el tamaño de las anclas utilizadas por el modelo.</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">¿Cuál es la innovación principal introducida en YOLOv2 en comparación con la versión original de YOLO?</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 4)" data-question="4">
                    <div class="answer-option">A</div>
                    <div class="answer-text">Uso de un backbone Darknet-53.</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, true, 'B', 4)" data-question="4">
                    <div class="answer-option">B</div>
                    <div class="answer-text">Introducción de anclas (anchor boxes) para mejorar la precisión de localización.</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 4)" data-question="4">
                    <div class="answer-option">C</div>
                    <div class="answer-text">Adición de detección multi-escala.</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'B', 4)" data-question="4">
                    <div class="answer-option">D</div>
                    <div class="answer-text">Uso de un codificador transformer.</div>
                </button>
        ...
        <div class="question-container">
            <div class="question-header">
                ...
                <div class="question-text">¿Cuál es una de las limitaciones mayores del algoritmo YOLO original relacionada con la predicción por celda de la cuadrícula?</div>
            </div>
            <div class="answers">
        
                <button class="answer-button" onclick="checkAnswer(this, true, 'A', 5)" data-question="5">
                    <div class="answer-option">A</div>
                    <div class="answer-text">Cada celda solo puede predecir una sola clase pero varias cajas.</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 5)" data-question="5">
                    <div class="answer-option">B</div>
                    <div class="answer-text">Cada celda puede detectar varios objetos de diferentes clases.</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 5)" data-question="5">
                    <div class="answer-option">C</div>
                    <div class="answer-text">El modelo no predice la posición de los objetos, solo la clase.</div>
                </button>
            
                <button class="answer-button" onclick="checkAnswer(this, false, 'A', 5)" data-question="5">
                    <div class="answer-option">D</div>
                    <div class="answer-text">Cada celda solo puede predecir una sola caja y una sola clase.</div>
                </button>
